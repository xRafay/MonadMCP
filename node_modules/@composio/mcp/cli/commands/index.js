...
const en_1 = __importDefault(__webpack_require__(9460));
...
// EXTERNAL MODULE: ../../mcp-typescript-sdk/node_modules/.pnpm/whatwg-url@5.0.0/node_modules/whatwg-url/lib/public-api.js
var public_api = __webpack_require__(6109);
// EXTERNAL MODULE: external "https"
var external_https_ = __webpack_require__(5692);
;// external "zlib"
const external_zlib_namespaceObject = require("zlib");
;// ../../mcp-typescript-sdk/node_modules/.pnpm/node-fetch@2.7.0/node_modules/node-fetch/lib/index.mjs
...
const pkce_challenge_1 = __importDefault(__webpack_require__(2929));
const types_js_1 = __webpack_require__(4308);
const auth_js_1 = __webpack_require__(7661);
...
const stdio_js_1 = __webpack_require__(8706);
/**
...
class StdioServerTransport {
    constructor(_stdin = process_1.default.stdin, _stdout = process_1.default.stdout) {
        this._stdin = _stdin;
...
const eventsource_1 = __webpack_require__(8501);
...
const oldEventSource = __webpack_require__(4927);
...
const crossFetch = __webpack_require__(6288);
...
const types_js_1 = __webpack_require__(4308);
const auth_js_1 = __webpack_require__(1179);
...
const util_1 = __webpack_require__(5113);
...
__exportStar(__webpack_require__(4346), exports);
__exportStar(__webpack_require__(5577), exports);
__exportStar(__webpack_require__(5113), exports);
__exportStar(__webpack_require__(2498), exports);
__exportStar(__webpack_require__(2106), exports);
...
const errors_1 = __webpack_require__(172);
const errorUtil_1 = __webpack_require__(7543);
const parseUtil_1 = __webpack_require__(4346);
const util_1 = __webpack_require__(5113);
const ZodError_1 = __webpack_require__(2106);
...
/* harmony export */   generateChallenge: () => (/* binding */ $d415641d0cfd8c85$export$6a61b14641fe7480),
/* harmony export */   verifyChallenge: () => (/* binding */ $d415641d0cfd8c85$export$4faf58fdf1185e54)
/* harmony export */ });
/* harmony import */ var crypto_js_lib_typedarrays__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8746);
/* harmony import */ var crypto_js_lib_typedarrays__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(crypto_js_lib_typedarrays__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var crypto_js_sha256__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9331);
...
/* harmony import */ var crypto_js_enc_base64url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7223);
/* harmony import */ var crypto_js_enc_base64url__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(crypto_js_enc_base64url__WEBPACK_IMPORTED_MODULE_2__);
 ...
 */ function $d415641d0cfd8c85$var$getRandomValues(size) {
    const randoms = crypto_js_lib_typedarrays__WEBPACK_IMPORTED_MODULE_0___default().random(size);
    const randoms1byte = [];
...
function $d415641d0cfd8c85$export$6a61b14641fe7480(code_verifier) {
    return crypto_js_sha256__WEBPACK_IMPORTED_MODULE_1___default()(code_verifier).toString((crypto_js_enc_base64url__WEBPACK_IMPORTED_MODULE_2___default()));
}
...
const conversions = __webpack_require__(312);
const utils = __webpack_require__(1032);
const Impl = __webpack_require__(6075);
...
const zod_1 = __webpack_require__(8003);
...
const tr46 = __webpack_require__(9615);
...
const protocol_js_1 = __webpack_require__(4095);
const types_js_1 = __webpack_require__(4308);
/**
...
const usm = __webpack_require__(4576);
...
exports.URL = __webpack_require__(3148)["interface"];
/* unused reexport */ __webpack_require__(4576).serializeURL;
/* unused reexport */ __webpack_require__(4576).serializeURLOrigin;
/* unused reexport */ __webpack_require__(4576).basicURLParse;
/* unused reexport */ __webpack_require__(4576).setTheUsername;
/* unused reexport */ __webpack_require__(4576).setThePassword;
/* unused reexport */ __webpack_require__(4576).serializeHost;
/* unused reexport */ __webpack_require__(4576).serializeInteger;
/* unused reexport */ __webpack_require__(4576).parseURL;
...
const nodeFetch = __webpack_require__(1137)
...
;(function (root, factory) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__webpack_require__(5743));
	}
	else {}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.z = void 0;
const z = __importStar(__webpack_require__(2495));
exports.z = z;
__exportStar(__webpack_require__(2495), exports);
exports["default"] = z;
...
Object.defineProperty(exports, "__esModule", ({ value: !0 }));
var eventsourceParser = __webpack_require__(4552);
...
var mappingTable = __webpack_require__(5578);
...
logStderr) {
    const { SSEClientTransport, } = __webpack_require__(1856);
    // Lazy import Client and StdioServerTransport to avoid ESM issues
    const { Client, } = __webpack_require__(5973);
...
// EXTERNAL MODULE: ../../mcp-typescript-sdk/dist/cjs/server/stdio.js
var stdio = __webpack_require__(1512);
// EXTERNAL MODULE: ../../mcp-typescript-sdk/dist/cjs/server/index.js
var server = __webpack_require__(9761);
...
async function sseToStdio(sseUrl) {
    ...
    const stdioServer = new server/* Server */.g(sseClient.getServerVersion()
        ? {
            name: 'mcp-transport',
            version: getVersion(),
        }
    ...
    const stdioTransport = new stdio.StdioServerTransport();
...
function saveMcpConfig(url, clientType, mcpUrl, command) {
    const config = {
        command: 'npx',
